...
export async function createVrfAccount(program: Program<NoLossLottery>, clientAccounts: ClientAccounts, argv: any): Promise<void> {
  const { payer, cluster, rpcUrl, queueKey, keypair, maxResult, drawDuration, ticketPrice} = argv;
  ...
  await program.rpc.initState(
    ...
    },
    {
      accounts: {
        ...
        tickets: clientAccounts.tickets,
